    ...
    async execute(client, message, args, Discord, prefix) {
        ...
        hypixel.getPlayer(player).then((player) => {
            const crazywalls = new Discord.MessageEmbed()
                ...
                .setFooter(`Crazy Walls Statistics requested by ${message.author.tag} • ${currentDate.getUTCMonth()}/${currentDate.getUTCDate()}/${currentDate.getUTCFullYear()} @ ${currentDate.getUTCHours()}:${currentDate.getUTCMinutes()} UTC`, message.author.displayAvatarURL())
            ...
            return message.reply({ embeds: [crazywalls], allowedMentions: { repliedUser: false } });
