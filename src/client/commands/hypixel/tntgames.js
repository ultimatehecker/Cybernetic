    ...
    async execute(client, message, args, Discord, prefix) {
        ...
        hypixel.getPlayer(player).then((player) => {
            ...
            const embed = new Discord.MessageEmbed()
                ...
                .setFooter(`TNT Games Statistics requested by ${message.author.tag} • ${currentDate.getUTCMonth()}/${currentDate.getUTCDate()}/${currentDate.getUTCFullYear()} @ ${currentDate.getUTCHours()}:${currentDate.getUTCMinutes()} UTC`,message.author.displayAvatarURL())
